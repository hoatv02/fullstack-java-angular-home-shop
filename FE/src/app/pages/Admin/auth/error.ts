...
@Component({
    ...
    >
      <div class="flex flex-col items-center justify-center">
        <div
          style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, rgba(233, 30, 99, 0.4) 10%, rgba(33, 150, 243, 0) 95%)"
        >
          <div
          ...
          >
            <div class="gap-4 flex flex-col items-center">
              ...
              <div class="col-span-12 mt-8 text-center">
                <p-button [label]="'Error.Button' | translate" routerLink="/" severity="danger" />
              </div>
            </div>
          </div>
        </div>
